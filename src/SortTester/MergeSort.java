...
public class MergeSort extends testMethod
{
private static Student[] array;
	...
	{
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.MergeSort((Student[])arr,Student.GradeComparatorAscending);
	...
	public void sortDesc() {
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.MergeSort((Student[])arr,Student.GradeComparatorDescending);
