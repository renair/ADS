...
public class SelectionSort extends testMethod
{
private static Student[] array;
	...
	public void sortAsc()
	{
		...
		org.junit.Assert.assertFalse(isSortedAsc(arr));
	}
	...
	{
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.SelectionSort((Student[])arr,Student.GradeComparatorAscending);
	...
	public void sortDesc() {
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.SelectionSort((Student[])arr,Student.GradeComparatorDescending);
