...
public class HeapSort extends testMethod
{
private static Student[] array;
	...
	{
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.HeapSort((Student[])arr,Student.GradeComparatorAscending);
	...
	public void sortDesc() {
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.HeapSort((Student[])arr,Student.GradeComparatorDescending);
