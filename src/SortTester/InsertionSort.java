...
public class InsertionSort extends testMethod
{
private static Student[] array;
	...
	{
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.InsertionSort((Student[])arr,Student.GradeComparatorAscending);
	...
	public void sortDesc() {
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.InsertionSort((Student[])arr,Student.GradeComparatorDescending);
