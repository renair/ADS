...
public class ShellSort extends testMethod
{
private static Student[] array;
	...
	{
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.ShellSort((Student[])arr,Student.GradeComparatorAscending);
	...
	public void sortDesc() {
		Student[] arr = Arrays.copyOf(array, array.length);
		Sorter.ShellSort((Student[])arr,Student.GradeComparatorDescending);
